...
def calculate_esg_score(company_data, employee_data):
    ...
    #Total social
    total_social = round((leader_confidence + employee_inclusion + average_salary_rating + diversity_index + work_hours_rating + tenure_promotion_index + health_satisfaction_index + wellbeing_training_index + employee_job_related_training + turnover_rating + average_culture_satisfaction), 2)
