...
def run():
    ...
    if company_code:
        ...
        employee_answers["colleague_respect"] = st.slider("On a scale of 1-10, how much do you feel that colleagues respect and value each other’s opinions?", 1, 10)            employee_answers["health_wellbeing"] = st.slider("Do you feel your workplace supports your physical and mental health effectively (1-10)?", 1, 10)
